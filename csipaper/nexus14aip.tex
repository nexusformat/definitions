...
NeXus allows multi dimensional scans too. Note that interrupting a multi-dimensional scan may leave some of 
the data in an invalid state. This can be prevented by unfolding the multi-dimensional scan to a one-dimensional one 
as described  above.  
