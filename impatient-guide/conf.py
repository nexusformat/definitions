...
project = "NeXus for the Impatient"
copyright = f"2014-{year}, http://nexusformat.org"
...
latex_documents = [
    ("index", "NXImpatient.tex", project, "nexusformat.org", "howto"),
]
...
man_pages = [("index", "nximpatient", project, ["nexusformat.org"], 1)]
...
epub_title = project
epub_author = "nexusformat.org"
epub_publisher = "http://nexusformat.org"
