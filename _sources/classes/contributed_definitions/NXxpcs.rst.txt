...
**Structure**:
  ...
  **entry**: (required) :ref:`NXentry`
    ...
    **data**: (required) :ref:`NXdata`
      ...
      **G2_unnormalized**: (optional) :ref:`NX_NUMBER <NX_NUMBER>` {units=\ :ref:`NX_DIMENSIONLESS <NX_DIMENSIONLESS>`}
      ...
      **delay_difference**: (optional) :ref:`NX_INT <NX_INT>` {units=\ :ref:`NX_INT <NX_INT>`}
    ...
    **instrument**: (required) :ref:`NXinstrument`
      ...
      **incident_beam**: (required) :ref:`NXbeam`
        ...
        **incident_energy**: (required) :ref:`NX_FLOAT <NX_FLOAT>` {units=\ :ref:`NX_ENERGY <NX_ENERGY>`}
        ...
        **extent**: (optional) :ref:`NX_FLOAT <NX_FLOAT>` {units=\ :ref:`NX_LENGTH <NX_LENGTH>`}
      ...
      **DETECTOR**: (required) :ref:`NXdetector`
        ...
        **count_time**: (required) :ref:`NX_NUMBER <NX_NUMBER>` {units=\ :ref:`NX_TIME <NX_TIME>`}
      ...
      **masks**: (optional) :ref:`NXnote`
        ...
        **dynamic_roi_map**: (required) :ref:`NX_DIMENSIONLESS <NX_DIMENSIONLESS>`
        ...
        **static_roi_map**: (optional) :ref:`NX_DIMENSIONLESS <NX_DIMENSIONLESS>`
    ...
    **sample**: (optional) :ref:`NXsample`
      ...
      **position_x**: (optional) :ref:`NXpositioner`


      .. _/NXxpcs/entry/sample/position_y-group:

      **position_y**: (optional) :ref:`NXpositioner`


      .. _/NXxpcs/entry/sample/position_z-group:

      **position_z**: (optional) :ref:`NXpositioner`
