...
**Groups cited**:
  :ref:`NXgeometry`, :ref:`NXnote`, :ref:`NXtransformations`

.. index:: NXtransformations (base class); used in base class, NXgeometry (base class); used in base class, NXnote (base class); used in base class
