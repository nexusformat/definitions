...
copyright = u'2014, http://nexusformat.org'
...
# try to get version from CPack NXDL configuration
nxdl_version_file = '../../cmake_include/nxdl_release.cmake'
nxdl_version = read_NXDL_version_number(nxdl_version_file)
