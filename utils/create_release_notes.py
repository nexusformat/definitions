...
#         commits = self.db["commits"] = {commit.sha: commit for commit in compare.commits}
    ...
    def print_report(self):
        ...
        print("-"*5, " | ", "-"*5)
        print("[New Tags](#tags) | ", len(self.db["tags"]))
        print("[Pull Requests](#pull-requests) | ", len(self.db["pulls"]))
        print("[Issues](#issues) | ", len(self.db["issues"]))
        print("[Commits](#commits) | ", len(self.db["commits"]))
        print("")
        print("### Tags")
        print("")
